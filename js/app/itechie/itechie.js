...
export class ITechie extends Component {
  ...
  handleAddJob(e) {
    e.preventDefault();
    axios.post('http://icore.repairmonk.com/website/createjob/', {customer_id: cookies.get('userId'), location_code: 'KR', address_id: 14813, device_id: cookies.get('device-model-id'), problems: cookies.get('device-issues'), colour: cookies.get('device-colour'), type: 'Doorstep'}, JSON.stringify(axiosConfig))
      .then(response => {
        console.log(response);
